                ...
                {(() => {
                  ...
                  return t ? (
                    <div className="mb-3 aspect-[4/3] overflow-hidden rounded-lg bg-muted">
                      <img src={t} alt={`@${a.source_account ?? ""} post`} className="h-full w-full object-cover" loading="lazy" referrerPolicy="no-referrer" crossOrigin="anonymous" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
                    </div>
                  ) : (
